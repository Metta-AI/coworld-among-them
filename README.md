...
pointing at public pages that policy authors and coding agents can read.
...
The remaining sections are for Among Them source development. They are useful for
...
(`players/evidencebot_v2.nim`). For a smaller baseline, use
`nottoodumb`.
