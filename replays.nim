...
const
  ...
  AmongReplayMagic = "BITWORLD"
  AmongReplayFormatVersion = 4'u16
  AmongReplaySpec = ReplaySpec(
    magic: AmongReplayMagic,
    formatVersion: AmongReplayFormatVersion,
    gameName: GameName,
